(function($, elementor) {
    ...
    var widgetReveal = function($scope, $) {
        var $reveal = $scope.find('.bdt-reveal-slider'),
        $settings = $reveal.data('settings');
        ...
        class Slide {
            constructor(el) {
                ...
                this.DOM.quote = this.DOM.el.querySelector('.bdt-description');
                // Some config values.
                this.config = {
                    revealer: {
    ...
    jQuery(window).on('elementor/frontend/init', function() {
        elementorFrontend.hooks.addAction('frontend/element_ready/prime-slider-reveal.default', widgetReveal);
    });
