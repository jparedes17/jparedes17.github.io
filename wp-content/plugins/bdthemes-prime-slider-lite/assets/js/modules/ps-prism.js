(function($, elementor) {
    ...
    var widgetPrism = function($scope, $) {
        var $prism = $scope.find('.bdt-prism-slider'),
        $settings = $prism.data('settings');
        ...
        if (!$prism.length) {
            ...
            const slideshow = new Slideshow(document.querySelector($settings.id + ' .slideshow'));
    ...
    // custom start
        ...
        $(".bdt-prism-slider").mousemove(function(e) {
            parallaxIt(e, ".slide__img-wrap", -20);
            parallaxIt(e, ".slide__title", -50);
        });

        function parallaxIt(e, target, movement) {
            var $this = $(".slide__title");
    ...
    jQuery(window).on('elementor/frontend/init', function() {
        elementorFrontend.hooks.addAction('frontend/element_ready/prime-slider-prism.default', widgetPrism);
    });
